                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>
                                                    <?php 
                                                        echo qtyTotalProduits();
                                                    echo "</h2> <span>Produits en Inventaire.</span><br>";
                                                    if (qtyTotalProduits() <= 75){
                                                        echo "<strong><span style='color:#FF4500;'>Stock trop bas</span></strong>";
                                                    }
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2><?php echo '$'.valeurProduits();?></h2>
                                                <span>Valeur des produits en inventaire.</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
